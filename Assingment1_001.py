...
def writeExcelData2FullDataSheet(excelfile, data, female_bins, male_bins):
    ...
    worksheet_queries['B6'] = 'Male'
    worksheet_queries['C6'] = male_bins[inch_index_70]/(female_bins[inch_index_70]+male_bins[inch_index_70])

    worksheet_queries['B7'] = 'Male'
    worksheet_queries['C7'] = male_bins[inch_index_75]/(female_bins[inch_index_75]+male_bins[inch_index_75])

    worksheet_queries['B8'] = 'Male'
    worksheet_queries['C8'] = male_bins[inch_index_80]/(female_bins[inch_index_80]+male_bins[inch_index_80])
    ...
    print('Basyes Classifier 55 FEMALE FULL ->{}'.format(female_55))
    print('Basyes SD ->{}'.format(np.std(female_array)))
    print('Basyes MEAN ->{}'.format(female_array.mean()))
    ...
    worksheet_queries['D6'] = 'Male'
    worksheet_queries['E6'] = np.round(male_70 / (female_70 + male_70), 10)

    worksheet_queries['D7'] = 'Male'
    worksheet_queries['E7'] = np.round(male_75 / (female_75 + male_75), 10)

    worksheet_queries['D8'] = 'Male'
    worksheet_queries['E8'] = np.round(male_80 / (female_80 + male_80), 10)
...
def writeExcelData2PartialDataSheet(excelfile, data, female_bins, male_bins, all_min, all_max):
    ...
    worksheet_queries['B15'] = 'Male'
    if female_bins[inch_index_70]+male_bins[inch_index_70] == 0:
        worksheet_queries['C15'] = 0
    else :
        worksheet_queries['C15'] = male_bins[inch_index_70]/(female_bins[inch_index_70]+male_bins[inch_index_70])

    worksheet_queries['B16'] = 'Male'
    if female_bins[inch_index_75]+male_bins[inch_index_75] == 0:
        worksheet_queries['C16'] = 0
    else :
        worksheet_queries['C16'] = male_bins[inch_index_75]/(female_bins[inch_index_75]+male_bins[inch_index_75])

    worksheet_queries['B17'] = 'Male'
    if female_bins[inch_index_80]+male_bins[inch_index_80] == 0:
        worksheet_queries['C17'] = 0
    else :
        worksheet_queries['C17'] = male_bins[inch_index_80]/(female_bins[inch_index_80]+male_bins[inch_index_80])
    ...
    worksheet_queries['D15'] = 'Male'
    worksheet_queries['E15'] = np.round(male_70 / (female_70 + male_70), 10)

    worksheet_queries['D16'] = 'Male'
    worksheet_queries['E16'] = np.round(male_75 / (female_75 + male_75), 10)

    worksheet_queries['D17'] = 'Male'
    worksheet_queries['E17'] = np.round(male_80 / (female_80 + male_80), 10)
...
rects1 = plt.bar(bincenters-(binwidth/2), HF_partial, binwidth,
                 alpha=opacity,
                 color='pink',
                 edgecolor='black',
                 label='Female')

rects2 = plt.bar(bincenters+(binwidth/2), HM_partial, binwidth,
                 alpha=opacity,
                 color='b',
                 edgecolor='black',
                 label='Male')

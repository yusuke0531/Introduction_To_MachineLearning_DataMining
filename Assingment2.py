...
# Follow several lines don't work as I expected. It's caused by manipulating array problem in Numpy.
#for i in range(len(query)):
...
# write query sheet probability of query by gender
write_querysheet_excel_histogram(excel_file, query, histo_female, histo_male,
                                                         BINS, min_height, max_height,
                                                         min_handspan, max_handspan)
